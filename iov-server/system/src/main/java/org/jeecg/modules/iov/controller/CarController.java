...
public class CarController extends JeecgController<Car, ICarService> {
    ...
    public Result<?> add(@RequestBody Car car) {
        System.out.println("code"+car.getSysOrgCode());
        carService.add(car);
    ...
    @RequestMapping(value = "/updateMotorcadeById")
    public Result<?> updateMotorcadeById(@RequestParam(name = "carId") String carId, @RequestParam(name = "motorcadeId") String motorcadeId) {
        String motorcadeCode=null;
        if (motorcadeId!=null&&!"".equals(motorcadeId))
            motorcadeCode = sysDepartService.getById(motorcadeId).getOrgCode();
        carService.updateMotorcadeById(carId,motorcadeCode);
        return Result.ok("编辑成功!");
    }
}
