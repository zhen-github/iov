...
-- ----------------------------
-- Table structure for iov_breakdown
-- ----------------------------
DROP TABLE IF EXISTS `iov_breakdown`;
CREATE TABLE `iov_breakdown`  (
  ...
  `breakdown_code` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '故障码',
  `definition` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '定义',
  `mean` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '故障描述',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of iov_breakdown
-- ----------------------------
INSERT INTO `iov_breakdown` VALUES ('1230786715063828482', 'admin', '2020-02-21 17:29:54', 'admin', '2020-02-21 17:30:09', 'A01', 'asfddf', '', '测试');
INSERT INTO `iov_breakdown` VALUES ('1232638219613790210', 'admin', '2020-02-26 20:07:08', 'admin', '2020-03-24 14:56:45', 'A01', 'p1001', 'fff', '所涉及的');
INSERT INTO `iov_breakdown` VALUES ('1232638274311708674', 'admin', '2020-02-26 20:07:21', 'admin', '2020-03-24 14:56:51', 'A01', 'p1002', 'fff', '手巾花氎净');
INSERT INTO `iov_breakdown` VALUES ('1232638307664814081', 'admin', '2020-02-26 20:07:29', 'admin', '2020-03-24 14:46:34', 'A01', 'p1003', 'sss', '我单位');

-- ----------------------------
-- Table structure for iov_car
-- ----------------------------
DROP TABLE IF EXISTS `iov_car`;
CREATE TABLE `iov_car`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属部门',
  `mac` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT 'mac(暂定 车辆唯一标识)',
  `brand` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '车辆品牌',
...
-- Records of iov_car
-- ----------------------------
INSERT INTO `iov_car` VALUES ('1230834655631421442', 'iov', '2020-02-21 20:40:24', NULL, NULL, 'A01', 'asd', 'dad', 'dada', NULL);
INSERT INTO `iov_car` VALUES ('1231164026292461570', 'admin', '2020-02-22 18:29:12', NULL, NULL, 'A01A03', '12', '33', '33', NULL);
INSERT INTO `iov_car` VALUES ('1231164118487457793', 'admin', '2020-02-22 18:29:34', NULL, NULL, NULL, 'fef', '23', 'jyt', NULL);
INSERT INTO `iov_car` VALUES ('1232221414793576450', 'admin', '2020-02-25 16:30:54', NULL, NULL, 'A01', 'D8CB8A828D3D', 'cc', '6666666', NULL);
INSERT INTO `iov_car` VALUES ('1243141330254082050', 'admin', '2020-03-26 19:42:44', NULL, NULL, NULL, 'dkfjienv', 'cdsre', '1572', NULL);
INSERT INTO `iov_car` VALUES ('1243143410821771266', 'admin', '2020-03-26 19:51:00', NULL, NULL, 'A01', 'd23sd', 'wqe', 'ddddddd33', NULL);
INSERT INTO `iov_car` VALUES ('1243143670163976194', 'admin', '2020-03-26 19:52:02', NULL, NULL, 'A01A05', '111', '222', '333', NULL);

-- ----------------------------
-- Table structure for iov_car_log
-- ----------------------------
DROP TABLE IF EXISTS `iov_car_log`;
CREATE TABLE `iov_car_log`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属部门',
  `car_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '车牌号',
  `status` int(1) NULL DEFAULT NULL COMMENT '状态',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of iov_car_log
-- ----------------------------
INSERT INTO `iov_car_log` VALUES ('1233010921356840961', 'admin', '2020-02-27 20:48:06', NULL, NULL, 'A01', '1232221414793576450', 1);
INSERT INTO `iov_car_log` VALUES ('1233011775027728385', 'admin', '2020-02-27 20:51:30', NULL, NULL, 'A01', '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1233377151339085825', NULL, '2020-02-28 21:03:22', NULL, '2020-02-28 21:05:05', NULL, '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1233377673785786370', NULL, '2020-02-28 21:05:27', NULL, '2020-02-28 21:05:42', NULL, '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1233378054947356674', NULL, '2020-02-28 21:06:58', NULL, '2020-02-28 21:08:05', NULL, '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1233378162719997953', NULL, '2020-02-28 21:07:24', NULL, '2020-02-28 21:07:54', NULL, '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1243081045577203713', NULL, '2020-03-26 15:43:11', NULL, '2020-03-26 15:43:21', NULL, '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1243087929096962050', NULL, '2020-03-26 16:10:32', NULL, '2020-03-26 16:10:46', NULL, NULL, 0);
INSERT INTO `iov_car_log` VALUES ('1243092185212444673', NULL, '2020-03-26 16:27:27', NULL, '2020-03-26 16:27:37', NULL, '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1243092610514870273', NULL, '2020-03-26 16:29:09', NULL, '2020-03-26 16:29:19', NULL, '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1243096844186607617', NULL, '2020-03-26 16:45:58', NULL, '2020-03-26 16:46:02', NULL, '1232221414793576450', 0);
INSERT INTO `iov_car_log` VALUES ('1243113974089048065', NULL, '2020-03-26 17:54:02', NULL, '2020-03-26 17:54:09', NULL, NULL, 0);
INSERT INTO `iov_car_log` VALUES ('1243115826163671042', NULL, '2020-03-26 18:01:24', NULL, '2020-03-26 18:09:27', NULL, NULL, 0);
INSERT INTO `iov_car_log` VALUES ('1243116013535813634', NULL, '2020-03-26 18:02:08', NULL, '2020-03-26 18:05:07', NULL, NULL, 0);
INSERT INTO `iov_car_log` VALUES ('1243118325863997441', NULL, '2020-03-26 18:11:20', NULL, '2020-03-26 18:11:26', NULL, '1232221414793576450', 0);

-- ----------------------------
-- Table structure for iov_car_status
-- ----------------------------
DROP TABLE IF EXISTS `iov_car_status`;
CREATE TABLE `iov_car_status`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  ...
  `car_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '车牌号',
  `status` int(1) NULL DEFAULT NULL COMMENT '状态',
  `speed` double(10, 0) NULL DEFAULT NULL COMMENT '车速',
  `rotation` int(11) NULL DEFAULT NULL COMMENT '转速',
  `acceleration` double(10, 0) NULL DEFAULT NULL COMMENT '加速度',
  `inclination` double(10, 0) NULL DEFAULT NULL COMMENT '倾斜角度',
  `idling` double(10, 0) NULL DEFAULT NULL COMMENT '怠速时间',
  `coolant_temperature` double(10, 0) NULL DEFAULT NULL COMMENT '冷却液温度',
  `onflow_temperature` double(10, 0) NULL DEFAULT NULL COMMENT '进气温度',
  `engine_oil_temperature` double(10, 0) NULL DEFAULT NULL COMMENT '机油温度',
  `latitude` double(21, 18) NULL DEFAULT NULL COMMENT '纬度',
  `longitude` double(21, 18) NULL DEFAULT NULL COMMENT '经度',
  `breakdown` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '故障',
  `catalyzer_tem_one_one` double(10, 0) NULL DEFAULT NULL COMMENT '催化剂温度(缸组1,传感器1) ',
  `catalyzer_tem_two_one` double(10, 0) NULL DEFAULT NULL COMMENT '催化剂温度(缸组2,传感器1) ',
  `catalyzer_tem_one_two` double(10, 0) NULL DEFAULT NULL COMMENT '催化剂温度(缸组1,传感器2) ',
  `catalyzer_tem_two_two` double(10, 0) NULL DEFAULT NULL COMMENT '催化剂温度(缸组2,传感器2) ',
  `osv_one_one` double(10, 0) NULL DEFAULT NULL COMMENT '氧传感器电压(缸组1,传感器1)',
  `osv_one_two` double(10, 0) NULL DEFAULT NULL COMMENT '氧传感器电压(缸组1,传感器2)',
  `osv_one_there` double(10, 0) NULL DEFAULT NULL COMMENT '氧传感器电压(缸组1,传感器3)',
  `osv_one_four` double(10, 0) NULL DEFAULT NULL COMMENT '氧传感器电压(缸组1,传感器4)',
  `osv_two_one` double(10, 0) NULL DEFAULT NULL COMMENT '氧传感器电压(缸组2,传感器1)',
  `osv_two_two` double(10, 0) NULL DEFAULT NULL COMMENT '氧传感器电压(缸组2,传感器2)',
  `osv_two_there` double(10, 0) NULL DEFAULT NULL COMMENT '氧传感器电压(缸组2,传感器3)',
  `osv_two_four` double(10, 0) NULL DEFAULT NULL COMMENT '氧传感器电压(缸组2,传感器4)',
  `stfc_one` double(10, 0) NULL DEFAULT NULL COMMENT '短期燃油修正(缸组1) ',
  `ltfc_one` double(10, 0) NULL DEFAULT NULL COMMENT '长期燃油修正(缸组1)',
  `stfc_two` double(10, 0) NULL DEFAULT NULL COMMENT '短期燃油修正(缸组2)',
  `ltfc_two` double(10, 0) NULL DEFAULT NULL COMMENT '长期燃油修正(缸组2)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of iov_car_status
-- ----------------------------
INSERT INTO `iov_car_status` VALUES ('1231164026372153346', 'iov', '2020-02-22 18:29:12', NULL, NULL, 'A01', '1231164026292461570', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status` VALUES ('1231164118529400833', 'admin', '2020-02-22 18:29:34', NULL, NULL, 'A01', '1231164118487457793', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status` VALUES ('1232221415020068865', 'admin', '2020-02-25 16:30:54', NULL, '2020-03-26 18:11:20', 'A01', '1232221414793576450', 0, 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 34.944249000000000000, 116.702003000000000000, 'p1001,p1003', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status` VALUES ('1243141330342162434', 'admin', '2020-03-26 19:42:44', NULL, NULL, 'A01', '1243141330254082050', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status` VALUES ('1243143410951794689', 'admin', '2020-03-26 19:51:00', NULL, NULL, 'A01', '1243143410821771266', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status` VALUES ('1243143670172364801', 'admin', '2020-03-26 19:52:02', NULL, NULL, 'A01', '1243143670163976194', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);

-- ----------------------------
-- Table structure for iov_car_status_log
-- ----------------------------
DROP TABLE IF EXISTS `iov_car_status_log`;
CREATE TABLE `iov_car_status_log`  (
  `id` varchar(36) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `create_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '创建人',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建日期',
  `update_by` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新人',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '更新日期',
  `sys_org_code` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属部门',
  `car_log_id` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '行车记录',
  `speed` double NULL DEFAULT NULL COMMENT '车速',
  `rotation` int(11) NULL DEFAULT NULL COMMENT '转速',
  `acceleration` double NULL DEFAULT NULL COMMENT '加速度',
  `inclination` double NULL DEFAULT NULL COMMENT '倾斜角度',
  `idling` double NULL DEFAULT NULL COMMENT '怠速时间',
  `coolant_temperature` double NULL DEFAULT NULL COMMENT '冷却液温度',
  `onflow_temperature` double NULL DEFAULT NULL COMMENT '进气温度',
  `engine_oil_temperature` double NULL DEFAULT NULL COMMENT '机油温度',
  `latitude` double(21, 18) NULL DEFAULT NULL COMMENT '纬度',
  `longitude` double(21, 18) NULL DEFAULT NULL COMMENT '经度',
  `breakdown` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '故障',
  `catalyzer_tem_one_one` double NULL DEFAULT NULL COMMENT '催化剂温度(缸组1,传感器1) ',
  `catalyzer_tem_two_one` double NULL DEFAULT NULL COMMENT '催化剂温度(缸组2,传感器1) ',
  `catalyzer_tem_one_two` double NULL DEFAULT NULL COMMENT '催化剂温度(缸组1,传感器2) ',
  `catalyzer_tem_two_two` double NULL DEFAULT NULL COMMENT '催化剂温度(缸组2,传感器2) ',
  `osv_one_one` double NULL DEFAULT NULL COMMENT '氧传感器电压(缸组1,传感器1)',
  `osv_one_two` double NULL DEFAULT NULL COMMENT '氧传感器电压(缸组1,传感器2)',
  `osv_one_there` double NULL DEFAULT NULL COMMENT '氧传感器电压(缸组1,传感器3)',
  `osv_one_four` double NULL DEFAULT NULL COMMENT '氧传感器电压(缸组1,传感器4)',
  `osv_two_one` double NULL DEFAULT NULL COMMENT '氧传感器电压(缸组2,传感器1)',
  `osv_two_two` double NULL DEFAULT NULL COMMENT '氧传感器电压(缸组2,传感器2)',
  `osv_two_there` double NULL DEFAULT NULL COMMENT '氧传感器电压(缸组2,传感器3)',
  `osv_two_four` double NULL DEFAULT NULL COMMENT '氧传感器电压(缸组2,传感器4)',
  `stfc_one` double NULL DEFAULT NULL COMMENT '短期燃油修正(缸组1) ',
  `ltfc_one` double NULL DEFAULT NULL COMMENT '长期燃油修正(缸组1)',
  `stfc_two` double NULL DEFAULT NULL COMMENT '短期燃油修正(缸组2)',
  `ltfc_two` double NULL DEFAULT NULL COMMENT '长期燃油修正(缸组2)',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of iov_car_status_log
-- ----------------------------
INSERT INTO `iov_car_status_log` VALUES ('1233017094529253378', 'admin', '2020-02-27 21:12:38', NULL, NULL, 'A01', '1233011775027728385', 125, NULL, NULL, 12, 12, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233377151792070657', NULL, '2020-02-28 21:03:23', NULL, NULL, NULL, '1233377151339085825', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 39.907629651061830000, 116.378688937255900000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233377343350128641', NULL, '2020-02-28 21:04:08', NULL, NULL, NULL, '1233377151339085825', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 39.907958845176710000, 116.386327868530320000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233377411968942082', NULL, '2020-02-28 21:04:25', NULL, NULL, NULL, '1233377151339085825', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 39.907432133833574000, 116.395340090820350000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233377440456654849', NULL, '2020-02-28 21:04:32', NULL, NULL, NULL, '1233377151339085825', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 39.907893006480290000, 116.406240588256880000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233377447725383682', NULL, '2020-02-28 21:04:33', NULL, NULL, NULL, '1233377151339085825', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 39.907958845176710000, 116.414137011596720000, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233377674305880065', NULL, '2020-02-28 21:05:27', NULL, NULL, NULL, '1233377673785786370', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378055144488962', NULL, '2020-02-28 21:06:58', NULL, NULL, NULL, '1233378054947356674', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378128343482370', NULL, '2020-02-28 21:07:16', NULL, NULL, NULL, '1233378054947356674', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378163084902401', NULL, '2020-02-28 21:07:24', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378228662845441', NULL, '2020-02-28 21:07:39', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378230197960706', NULL, '2020-02-28 21:07:40', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378231393337346', NULL, '2020-02-28 21:07:40', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378233133973505', NULL, '2020-02-28 21:07:40', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378234518093825', NULL, '2020-02-28 21:07:41', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378236183232514', NULL, '2020-02-28 21:07:41', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378237512826882', NULL, '2020-02-28 21:07:42', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378239190548482', NULL, '2020-02-28 21:07:42', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1233378240725663746', NULL, '2020-02-28 21:07:42', NULL, NULL, NULL, '1233378162719997953', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243081046747414529', NULL, '2020-03-26 15:43:12', NULL, NULL, NULL, '1243081045577203713', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243087929403146241', NULL, '2020-03-26 16:10:32', NULL, NULL, NULL, '1243087929096962050', 119, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243092185527017474', NULL, '2020-03-26 16:27:27', NULL, NULL, NULL, '1243092185212444673', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243092610816860162', NULL, '2020-03-26 16:29:09', NULL, NULL, NULL, '1243092610514870273', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243096844543123458', NULL, '2020-03-26 16:45:58', NULL, NULL, NULL, '1243096844186607617', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243113974449758210', NULL, '2020-03-26 17:54:02', NULL, NULL, NULL, '1243113974089048065', 119, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243115826390163457', NULL, '2020-03-26 18:01:24', NULL, NULL, NULL, '1243115826163671042', 49, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243116013787471874', NULL, '2020-03-26 18:02:08', NULL, NULL, NULL, '1243116013535813634', 119, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243116441895886850', NULL, '2020-03-26 18:03:50', NULL, NULL, NULL, '1243116013535813634', 119, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
INSERT INTO `iov_car_status_log` VALUES ('1243118326069518337', NULL, '2020-03-26 18:11:20', NULL, NULL, NULL, '1243118325863997441', 120, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO `onl_cgform_field` VALUES ('0137e1704aeb2c2b8e58178256702345', '4028818670868f2b0170868f2b420000', 'latitude', '纬度', 'latitude', 0, 1, 'double', 15, 12, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 17, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('060f77c0e7d072c012ac2ad037db20a2', '4028818670868f2b0170868f2b420000', 'car_log_id', '行车记录', 'car_log_id', 0, 1, 'string', 32, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 7, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('0892e8f75b3c7b9dcc5359369b9a362b', 'a30164d8cac1488d94157748435ede75', 'catalyzer_tem_one_two', '催化剂温度(缸组1,传感器2) ', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 22, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('08bd740802f3c1d9ebab2b39064bb1e1', 'a30164d8cac1488d94157748435ede75', 'ltfc_one', '长期燃油修正(缸组1)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 33, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('0aa794816a104d99b737310767704aec', '4028818670868f2b0170868f2b420000', 'catalyzer_tem_two_two', '催化剂温度(缸组2,传感器2) ', 'catalyzer_tem_two_two', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 23, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('0f05e73e4ead987e0fd2a2b72aa67d16', '4028818670868f2b0170868f2b420000', 'stfc_one', '短期燃油修正(缸组1) ', 'stfc_one', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 32, 'admin', '2020-02-27 21:08:45', '2020-02-27 20:11:35', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('0f4efeffed2fa2a584f4719c37626c08', '0f91761837f545e3be62f75526ec43d2', 'update_time', '更新日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 5, 'admin', '2020-02-21 16:02:34', '2020-02-21 15:45:27', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('11c572c496e67abb56d1cb0c67d30ecc', 'a30164d8cac1488d94157748435ede75', 'catalyzer_tem_two_two', '催化剂温度(缸组2,传感器2) ', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 23, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('145cae3528afb0a9c1f22920239369f7', '91bf9405b7c84fa38e0b5d85920b0b4f', 'sys_org_code', '所属部门', NULL, 0, 1, 'string', 64, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 6, 'admin', '2020-02-27 21:30:51', '2020-02-27 20:06:30', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('16da99ad74b9c411f0298376fea63ee5', '30c9507ab16547fba58bafaecb6560cb', 'update_time', '更新日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 5, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('252f6bd0345ee13fcda171e587aa1d92', '4028818670868f2b0170868f2b420000', 'sys_org_code', '所属部门', 'sys_org_code', 0, 1, 'string', 64, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 6, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('271d4a259679598907b2fbd0d1dec8e8', 'a30164d8cac1488d94157748435ede75', 'stfc_one', '短期燃油修正(缸组1) ', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 32, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('274fdc9ded6f2e449272e8a5fadf8ba1', '4028818670868f2b0170868f2b420000', 'update_by', '更新人', 'update_by', 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 4, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('2eab31db38ddbb800a12c44f4cece15a', '4028818670868f2b0170868f2b420000', 'stfc_two', '短期燃油修正(缸组2)', 'stfc_two', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 34, 'admin', '2020-02-27 21:08:45', '2020-02-27 20:11:35', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('2edce70384dc32d45526b0114a8213b9', '0f91761837f545e3be62f75526ec43d2', 'id', '主键', NULL, 1, 0, 'string', 36, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 1, 'admin', '2020-02-21 16:02:34', '2020-02-21 15:45:27', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('32556d6224336e9d7c7d7a539cb6bc30', '91bf9405b7c84fa38e0b5d85920b0b4f', 'update_time', '更新日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 1, 1, 1, 'group', '', '', 5, 'admin', '2020-02-27 21:30:51', '2020-02-27 20:06:30', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('325e41abe1ac7ddd93e623c9cbfb4516', 'a30164d8cac1488d94157748435ede75', 'inclination', '倾斜角度', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 12, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('34e99b39d080335c95be17f9531b7526', '30c9507ab16547fba58bafaecb6560cb', 'sys_org_code', '所属部门', NULL, 0, 1, 'string', 64, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 6, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('35878f5b82d3edde28b74b6419860425', '4028818670868f2b0170868f2b420000', 'catalyzer_tem_two_one', '催化剂温度(缸组2,传感器1) ', 'catalyzer_tem_two_one', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 21, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('35d03b1a0ce0421897d85a6ce318ed49', '4028818670868f2b0170868f2b420000', 'osv_two_four', '氧传感器电压(缸组2,传感器4)', 'osv_two_four', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 31, 'admin', '2020-02-27 21:08:45', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('37d5f00072a7aa2e3412cfcefc4f0f5d', '4028818670868f2b0170868f2b420000', 'coolant_temperature', '冷却液温度', 'coolant_temperature', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 14, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('384b9ad288b6fc9bf0380116c40370e6', 'a30164d8cac1488d94157748435ede75', 'catalyzer_tem_one_one', '催化剂温度(缸组1,传感器1) ', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 20, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('39874f1c890d917df16ffc0ace57b31f', '91bf9405b7c84fa38e0b5d85920b0b4f', 'status', '状态', NULL, 0, 1, 'int', 1, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 8, 'admin', '2020-02-27 21:30:51', '2020-02-27 20:06:30', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('3c5effd2f9e95f6b93c8ba4e6b727e7f', '4028818670868f2b0170868f2b420000', 'inclination', '倾斜角度', 'inclination', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 12, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('458186b17ec84b4c9eee0cc21e37f2b1', '30c9507ab16547fba58bafaecb6560cb', 'create_by', '创建人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 2, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('45b9ed74b9b5c05e0221444a7f048545', 'a30164d8cac1488d94157748435ede75', 'create_time', '创建日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 3, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:01:08', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('4755ef1df20c33e70e6739d8da56b4ac', 'a30164d8cac1488d94157748435ede75', 'coolant_temperature', '冷却液温度', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 14, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('483122c38991d47a47f7ac3e82c90827', '4028818670868f2b0170868f2b420000', 'longitude', '经度', 'longitude', 0, 1, 'double', 15, 12, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 18, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('4c7a1bede0dd34fa31180d7114c07813', 'a30164d8cac1488d94157748435ede75', 'stfc_two', '短期燃油修正(缸组2)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 34, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('4dd631a5276e6a7c67dbf7314d223b5d', 'a30164d8cac1488d94157748435ede75', 'update_time', '更新日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 5, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:01:08', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('571d73caacf231c7cf6f854d9b47d57a', '4028818670868f2b0170868f2b420000', 'rotation', '转速', 'rotation', 0, 1, 'int', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 10, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('5cfecbc3a389e124bdb258f544df3488', '4028818670868f2b0170868f2b420000', 'osv_two_one', '氧传感器电压(缸组2,传感器1)', 'osv_two_one', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 28, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('5e3ac1624bf480c2dd3dbc61ebe19fba', 'a30164d8cac1488d94157748435ede75', 'osv_one_four', '氧传感器电压(缸组1,传感器4)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 27, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('608bf47027c2a1fe136d285be44a3096', '91bf9405b7c84fa38e0b5d85920b0b4f', 'car_id', '车牌号', NULL, 0, 1, 'String', 32, 0, '', '', '', '', 'text', '', 120, NULL, '1', '', '', 0, 1, 1, 'single', 'iov_car', 'id', 7, 'admin', '2020-02-27 21:30:51', '2020-02-27 20:06:30', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('67bed611fc5b52f77c94cadf0ab2f643', '0f91761837f545e3be62f75526ec43d2', 'mean', '故障描述', NULL, 0, 0, 'String', 32, 0, '', '', '', '', 'text', '', 120, NULL, '1', '', '', 0, 1, 1, 'single', '', '', 8, 'admin', '2020-02-21 16:02:35', '2020-02-21 15:45:27', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('68b570d9bb7ec91640d403f797d182ce', 'a30164d8cac1488d94157748435ede75', 'speed', '车速', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 9, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:47:55', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('68bbd572b577f50e3c1b9804752d3e41', '4028818670868f2b0170868f2b420000', 'speed', '车速', 'speed', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 9, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('6b5d66f9323ddc572bdf1f26987c6e35', 'a30164d8cac1488d94157748435ede75', 'longitude', '经度', NULL, 0, 1, 'double', 32, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 18, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('73f642be14e56b35d5edcb098b865b89', '4028818670868f2b0170868f2b420000', 'create_time', '创建日期', 'create_time', 0, 1, 'Date', 0, 0, '', '', '', '', 'date', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 3, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('764504096c6950bf16b1003be6c52317', 'a30164d8cac1488d94157748435ede75', 'onflow_temperature', '进气温度', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 15, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('765ac116cdce2c4db63cd16b65284ac4', 'a30164d8cac1488d94157748435ede75', 'osv_one_two', '氧传感器电压(缸组1,传感器2)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 25, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('78ebed8495b549cd6af5dccea9aae851', '4028818670868f2b0170868f2b420000', 'catalyzer_tem_one_one', '催化剂温度(缸组1,传感器1) ', 'catalyzer_tem_one_one', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 20, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('7b5cc69a242d7e2297f040165903afea', '30c9507ab16547fba58bafaecb6560cb', 'update_by', '更新人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 4, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('82230fdb94d3ea5858454cbcb6093edd', '4028818670868f2b0170868f2b420000', 'osv_one_there', '氧传感器电压(缸组1,传感器3)', 'osv_one_there', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 26, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('859dc3fb1f37b0c497d0ba83e5f75333', 'a30164d8cac1488d94157748435ede75', 'engine_oil_temperature', '机油温度', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 16, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('85eed0af5b6ef669ae007f9f847000ea', '0f91761837f545e3be62f75526ec43d2', 'update_by', '更新人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 4, 'admin', '2020-02-21 16:02:34', '2020-02-21 15:45:27', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('8a61d691e7fbc81d9a2bd11afad3b956', 'a30164d8cac1488d94157748435ede75', 'status', '状态', NULL, 0, 1, 'int', 1, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 8, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:01:08', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('8bda74a98ab20061dea578be19f6ac57', 'a30164d8cac1488d94157748435ede75', 'latitude', '纬度', NULL, 0, 1, 'double', 32, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 17, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('8ea7ece720f5b54b0568794eab4c2898', 'a30164d8cac1488d94157748435ede75', 'id', '主键', NULL, 1, 0, 'string', 36, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 1, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:01:08', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('9079644b8d0c76346d0b6b0e36a8592d', '4028818670868f2b0170868f2b420000', 'create_by', '创建人', 'create_by', 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 2, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('95814ee20dc33313e961d532a9d83a95', 'a30164d8cac1488d94157748435ede75', 'breakdown', '故障', NULL, 0, 1, 'string', 32, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 19, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('9c61dac99debb4647d7c298ce2e21938', '0f91761837f545e3be62f75526ec43d2', 'create_time', '创建日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 3, 'admin', '2020-02-21 16:02:34', '2020-02-21 15:45:27', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('9c6bea9184e2b5284d8ac181b57f5b7a', '4028818670868f2b0170868f2b420000', 'osv_one_two', '氧传感器电压(缸组1,传感器2)', 'osv_one_two', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 25, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('a32e02e58ce81a4387d1c848e06b246f', '4028818670868f2b0170868f2b420000', 'ltfc_two', '长期燃油修正(缸组2)', 'ltfc_two', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 35, 'admin', '2020-02-27 21:08:45', '2020-02-27 20:11:35', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('a434c5217794ee85beb88c6a12b92b56', '0f91761837f545e3be62f75526ec43d2', 'breakdown_code', '故障码', NULL, 0, 0, 'String', 10, 0, '', '', '', '', 'text', '', 120, 'only', '1', '', '', 1, 1, 1, 'single', '', '', 7, 'admin', '2020-02-21 16:02:35', '2020-02-21 15:45:27', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('a849987b23b1cc39c43c673223d37a18', '4028818670868f2b0170868f2b420000', 'acceleration', '加速度', 'acceleration', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 11, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('a9471785547d52f1cf9ea6383d6fb170', 'a30164d8cac1488d94157748435ede75', 'osv_one_one', '氧传感器电压(缸组1,传感器1)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 24, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('ad3bd350ef24fa84679ddc80a3d82e9a', 'a30164d8cac1488d94157748435ede75', 'acceleration', '加速度', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 11, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('b12c9b5c73894a9be068b58f86ac1599', 'a30164d8cac1488d94157748435ede75', 'sys_org_code', '所属部门', NULL, 0, 1, 'string', 64, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 6, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:01:08', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('b1846bf57765b7144ae0d23f1a8fe978', '30c9507ab16547fba58bafaecb6560cb', 'car_number', '车牌号', NULL, 0, 0, 'String', 10, 0, '', '', '', '', 'text', '', 120, 'only', '1', '', '', 0, 1, 1, 'single', '', '', 9, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('b6385c369287c73e3b09e5b7b3a6a782', 'a30164d8cac1488d94157748435ede75', 'ltfc_two', '长期燃油修正(缸组2)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 35, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('b888eda4851f8be5701f59588f609f31', 'a30164d8cac1488d94157748435ede75', 'osv_two_two', '氧传感器电压(缸组2,传感器2)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 29, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('b8e6f28491aa266925404ed65fa9b9aa', 'a30164d8cac1488d94157748435ede75', 'update_by', '更新人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 4, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:01:08', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('c0d8f207e6e71949335687b731f2e888', '4028818670868f2b0170868f2b420000', 'idling', '怠速时间', 'idling', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 13, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('c17fc94290d451f3cb7b5bdbd682627e', '0f91761837f545e3be62f75526ec43d2', 'sys_org_code', '所属部门', NULL, 0, 1, 'string', 64, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 6, 'admin', '2020-02-21 16:02:35', '2020-02-21 15:45:27', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('c47997d188727360cf2b9d4d191b45e1', '91bf9405b7c84fa38e0b5d85920b0b4f', 'create_time', '创建日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 1, 1, 1, 'group', '', '', 3, 'admin', '2020-02-27 21:30:51', '2020-02-27 20:06:30', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('c81ca3c802d8d029609f0e402289a2af', '4028818670868f2b0170868f2b420000', 'onflow_temperature', '进气温度', 'onflow_temperature', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 15, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('ca8f252f892d2deb8a0a7c70dd8ce221', 'a30164d8cac1488d94157748435ede75', 'rotation', '转速', NULL, 0, 1, 'int', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 10, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('cac6d770facf73a1632c70083f485669', '91bf9405b7c84fa38e0b5d85920b0b4f', 'update_by', '更新人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 4, 'admin', '2020-02-27 21:30:51', '2020-02-27 20:06:30', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('cc6c50cb4c5f2b97664af5532344e742', 'a30164d8cac1488d94157748435ede75', 'catalyzer_tem_two_one', '催化剂温度(缸组2,传感器1) ', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 21, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('cde6daf0a8e92b468569a91f1ae16a42', '4028818670868f2b0170868f2b420000', 'catalyzer_tem_one_two', '催化剂温度(缸组1,传感器2) ', 'catalyzer_tem_one_two', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 22, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d3c416fd4bc91a9eb122db4cf59c527f', 'a30164d8cac1488d94157748435ede75', 'osv_two_four', '氧传感器电压(缸组2,传感器4)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 31, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d55c74faa4d646599351eeb6517898de', '4028818670868f2b0170868f2b420000', 'engine_oil_temperature', '机油温度', 'engine_oil_temperature', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 16, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d6041426d042cf616e123c153c8facf8', '30c9507ab16547fba58bafaecb6560cb', 'brand', '车辆品牌', NULL, 0, 1, 'String', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 8, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d723d6e987fb9d34a993fbca84dd0477', 'a30164d8cac1488d94157748435ede75', 'osv_two_there', '氧传感器电压(缸组2,传感器3)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 30, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('d7d6ab809f7bf8e68de256d4c852e1da', '91bf9405b7c84fa38e0b5d85920b0b4f', 'id', '主键', NULL, 1, 0, 'string', 36, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 1, 'admin', '2020-02-27 21:30:51', '2020-02-27 20:06:30', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('dadd1254a630eafcc803163209f6eb69', '30c9507ab16547fba58bafaecb6560cb', 'create_time', '创建日期', NULL, 0, 1, 'Date', 20, 0, '', '', '', '', 'datetime', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 3, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('dccb28ca3cc80a1d8217333b0b49453c', '4028818670868f2b0170868f2b420000', 'breakdown', '故障', 'breakdown', 0, 1, 'string', 32, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 19, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('de034bef2d304e2f86b01f6cc5543078', '4028818670868f2b0170868f2b420000', 'ltfc_one', '长期燃油修正(缸组1)', 'ltfc_one', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 33, 'admin', '2020-02-27 21:08:45', '2020-02-27 20:11:35', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('dec9cf35a8ba19af58a03ea45c0e4bd4', '4028818670868f2b0170868f2b420000', 'osv_two_two', '氧传感器电压(缸组2,传感器2)', 'osv_two_two', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 29, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('e3e87a0f35d0cafb5bc07378d079411a', '4028818670868f2b0170868f2b420000', 'id', 'id', 'id', 1, 0, 'string', 36, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 1, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('e4952528769c5e335cf2082a20820b5d', '4028818670868f2b0170868f2b420000', 'osv_two_there', '氧传感器电压(缸组2,传感器3)', 'osv_two_there', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 30, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('e5e2aeba15dcc7b19f61f2e6c3f6bd32', '30c9507ab16547fba58bafaecb6560cb', 'mac', 'mac(暂定 车辆唯一标识)', NULL, 0, 0, 'String', 32, 0, '', '', '', '', 'text', '', 120, 'only', '1', '', '', 0, 1, 1, 'single', '', '', 7, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('e9447b9950d2756a2f6137e409b40802', '30c9507ab16547fba58bafaecb6560cb', 'remark', '备注', NULL, 0, 1, 'String', 32, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 11, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('ec14b71d247c598e2b699b7c9e85bec9', 'a30164d8cac1488d94157748435ede75', 'create_by', '创建人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 2, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:01:08', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('edb9f7dcf0a7735e84f753f23d33ffd9', '4028818670868f2b0170868f2b420000', 'osv_one_four', '氧传感器电压(缸组1,传感器4)', 'osv_one_four', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 27, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('eddf6ad6526bf74d88b33ff9367b5398', 'a30164d8cac1488d94157748435ede75', 'osv_one_there', '氧传感器电压(缸组1,传感器3)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 26, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('f0da274dbfe5fd88c056f4b4c89b9648', 'a30164d8cac1488d94157748435ede75', 'osv_two_one', '氧传感器电压(缸组2,传感器1)', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 28, 'admin', '2020-02-21 20:51:25', '2020-02-21 16:35:19', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('f109d8294541ac6733513fa6fdb323e7', '0f91761837f545e3be62f75526ec43d2', 'create_by', '创建人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 2, 'admin', '2020-02-21 16:02:34', '2020-02-21 15:45:27', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('f4125d075d2f695511aa27f4c2cceb32', '4028818670868f2b0170868f2b420000', 'osv_one_one', '氧传感器电压(缸组1,传感器1)', 'osv_one_one', 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'group', '', '', 24, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
INSERT INTO `onl_cgform_field` VALUES ('f42def135c1454afe76c67676f123135', '30c9507ab16547fba58bafaecb6560cb', 'id', '主键', NULL, 1, 0, 'string', 36, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 1, 'admin', '2020-02-21 20:31:14', '2020-02-21 15:57:13', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('f699825f5f267f3f4ed062e16dc7c035', 'a30164d8cac1488d94157748435ede75', 'car_id', '车牌号', NULL, 0, 1, 'String', 32, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', 'iov_car', 'id', 7, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:01:08', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('fa19407beac1607246de572255ec90e7', '4028818670868f2b0170868f2b420000', 'update_time', '更新日期', 'update_time', 0, 1, 'Date', 0, 0, '', '', '', '', 'date', '', 120, NULL, '0', '', '', 0, 0, 0, 'group', '', '', 5, 'admin', '2020-02-27 21:08:44', '2020-02-27 20:11:35', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('fb40a241b87a6b89327ece2519dd3c6f', 'a30164d8cac1488d94157748435ede75', 'idling', '怠速时间', NULL, 0, 1, 'double', 10, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 1, 1, 'single', '', '', 13, 'admin', '2020-02-21 20:51:24', '2020-02-21 16:35:19', 'admin');
...
INSERT INTO `onl_cgform_field` VALUES ('fe760a34d50798630b8fb6cf9d00046d', '91bf9405b7c84fa38e0b5d85920b0b4f', 'create_by', '创建人', NULL, 0, 1, 'string', 50, 0, '', '', '', '', 'text', '', 120, NULL, '0', '', '', 0, 0, 0, 'single', '', '', 2, 'admin', '2020-02-27 21:30:51', '2020-02-27 20:06:30', 'admin');
...
-- ----------------------------
INSERT INTO `onl_cgform_head` VALUES ('0f91761837f545e3be62f75526ec43d2', 'iov_breakdown', 1, 2, '故障码', 'Y', 'Y', 'Y', 'N', NULL, 'UUID', 'single', NULL, NULL, NULL, NULL, NULL, NULL, 'bdfl_include', '1', NULL, 0, NULL, 0, NULL, 'admin', '2020-02-21 16:03:11', 'admin', '2020-02-21 15:45:27');
INSERT INTO `onl_cgform_head` VALUES ('30c9507ab16547fba58bafaecb6560cb', 'iov_car', 1, 3, '车辆管理', 'Y', 'Y', 'Y', 'N', NULL, 'UUID', 'single', NULL, NULL, NULL, NULL, NULL, NULL, 'bdfl_include', '1', NULL, 0, NULL, 0, NULL, 'admin', '2020-02-21 20:32:24', 'admin', '2020-02-21 15:57:13');
INSERT INTO `onl_cgform_head` VALUES ('4028818670868f2b0170868f2b420000', 'iov_car_status_log', 1, 4, '行车状态记录', 'Y', 'Y', 'Y', 'N', NULL, 'UUID', 'group', NULL, NULL, NULL, NULL, NULL, NULL, 'bdfl_include', '1', NULL, 0, NULL, 0, NULL, 'admin', '2020-02-27 21:09:00', 'admin', '2020-02-27 20:11:35');
...
INSERT INTO `onl_cgform_head` VALUES ('91bf9405b7c84fa38e0b5d85920b0b4f', 'iov_car_log', 1, 3, '行车记录', 'Y', 'Y', 'Y', 'N', NULL, 'UUID', 'single', NULL, NULL, NULL, NULL, NULL, NULL, 'bdfl_include', '1', NULL, 0, NULL, 0, NULL, 'admin', '2020-02-27 21:30:51', 'admin', '2020-02-27 20:06:30');
INSERT INTO `onl_cgform_head` VALUES ('a30164d8cac1488d94157748435ede75', 'iov_car_status', 1, 13, '车况', 'Y', 'N', 'Y', 'N', NULL, 'UUID', 'single', NULL, NULL, NULL, NULL, NULL, NULL, 'bdfl_include', '1', NULL, 0, NULL, 0, NULL, 'admin', '2020-02-21 20:51:25', 'admin', '2020-02-21 16:01:08');
...
INSERT INTO `sys_announcement_send` VALUES ('1197434450981543938', '93a9060a1c20e4bf98b3f768a02c2ff9', 'a75d45a015c44384a04449ee80dc3503', '1', '2020-02-20 14:47:12', 'jeecg', '2019-11-21 16:39:55', 'jeecg', '2020-02-20 14:47:12');
INSERT INTO `sys_announcement_send` VALUES ('1230384585110880257', '93a9060a1c20e4bf98b3f768a02c2ff9', '42d153bffeea74f72a9c1697874fa4a7', '0', NULL, 'test22', '2020-02-20 14:51:59', NULL, NULL);
...
-- ----------------------------
INSERT INTO `sys_depart` VALUES ('26c59b58f6ef4a6fa887760bcddd60cf', '2dc24b0ade8840499bee21225bf61222', '车队', NULL, NULL, 0, NULL, '2', '2', 'A03A02', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2020-03-26 20:05:33', NULL, NULL);
INSERT INTO `sys_depart` VALUES ('2dc24b0ade8840499bee21225bf61222', '', '车辆网', NULL, NULL, 0, NULL, '1', '1', 'A03', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2020-02-20 15:10:34', NULL, NULL);
INSERT INTO `sys_depart` VALUES ('2ef11379c1bf409cbe8842513fbfcfe5', '2dc24b0ade8840499bee21225bf61222', '开发部', NULL, NULL, 0, NULL, '2', '2', 'A03A01', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2020-02-20 15:10:47', NULL, NULL);
INSERT INTO `sys_depart` VALUES ('45998bdff72d43628c69b77ac8aaa557', 'c6d7cb4deeac411cb3384b1b31278596', 'addd123', NULL, NULL, 0, NULL, '2', '2', 'A01A06', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2020-03-30 17:19:38', 'admin', '2020-03-30 18:43:47');
INSERT INTO `sys_depart` VALUES ('4f1765520d6346f9bd9c79e2479e5b12', 'c6d7cb4deeac411cb3384b1b31278596', '一车队', NULL, NULL, 0, NULL, '1', '2', 'A01A03', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2019-02-20 17:15:34', 'admin', '2020-03-30 18:44:27');
...
INSERT INTO `sys_depart` VALUES ('62ad121a501244a2857f230f3cba82aa', 'c6d7cb4deeac411cb3384b1b31278596', 'er23', NULL, NULL, 0, NULL, '2', '2', 'A01A13', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2020-03-30 18:37:37', NULL, NULL);
...
INSERT INTO `sys_depart` VALUES ('b89d09ae3d8844ee8d138188ec64f88d', '2dc24b0ade8840499bee21225bf61222', 'vv', NULL, NULL, 0, NULL, '2', '2', 'A03A03', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2020-03-26 20:06:43', NULL, NULL);
...
INSERT INTO `sys_depart` VALUES ('f24d12f85e724757a81c784d55330aa9', '2ef11379c1bf409cbe8842513fbfcfe5', '测试', NULL, NULL, 0, NULL, '2', '3', 'A03A01A01', NULL, NULL, NULL, NULL, NULL, '0', 'admin', '2020-03-25 22:31:49', NULL, NULL);
...
INSERT INTO `sys_log` VALUES ('1230085909146677249', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-19 19:05:09', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230087179332993026', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-19 19:10:12', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230087274464002050', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-19 19:10:35', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230090353854816258', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-19 19:22:49', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230090443252211713', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-19 19:23:10', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230090511896190978', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-19 19:23:27', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230382578832670722', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:44:00', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230382672411787266', 2, '填值规则-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysFillRuleController.queryPageList()', NULL, NULL, NULL, 193, 'admin', '2020-02-20 14:44:23', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230383137442660353', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 47, 'admin', '2020-02-20 14:46:14', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230383172947443713', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 14, 'admin', '2020-02-20 14:46:23', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230383267872931842', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:46:45', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230383343630450689', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:47:03', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230383806723555330', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:48:54', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230383890940985345', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:49:14', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230383953633247233', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 13, 'admin', '2020-02-20 14:49:29', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230384507407204353', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:51:41', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230384580153212929', 1, '用户名: test22,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:51:58', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230384677108744193', 1, '用户名: 23232,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:52:21', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230384741084463106', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 14:52:36', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230388032849739778', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 12, 'admin', '2020-02-20 15:05:41', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230388287007784961', 1, '用户名: jeecg,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 15:06:42', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230388815628500993', 2, '职务表-分页列表查询', 1, 'jeecg', 'jeecg', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 16, 'jeecg', '2020-02-20 15:08:48', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230389126619365377', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 12, 'admin', '2020-02-20 15:10:02', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230389140733198337', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 9, 'admin', '2020-02-20 15:10:05', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230389524172275713', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 28, 'admin', '2020-02-20 15:11:37', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390177254768641', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 11, 'admin', '2020-02-20 15:14:12', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390208745603074', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 15, 'admin', '2020-02-20 15:14:20', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390301527801858', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 8, 'admin', '2020-02-20 15:14:42', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390420553760769', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 13, 'admin', '2020-02-20 15:15:10', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390503538065409', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 10, 'admin', '2020-02-20 15:15:30', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390723290234882', 2, '职务表-添加', 2, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.add()', NULL, '[{\"code\":\"useradmin\",\"createBy\":\"admin\",\"createTime\":1582182982577,\"id\":\"1230390723017605122\",\"name\":\"总理\",\"postRank\":\"5\",\"sysOrgCode\":\"A01\"}]', NULL, 67, 'admin', '2020-02-20 15:16:23', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390723680305153', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 23, 'admin', '2020-02-20 15:16:23', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390816877740034', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 13, 'admin', '2020-02-20 15:16:45', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390919290060802', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 12, 'admin', '2020-02-20 15:17:09', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230390985841082369', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 10, 'admin', '2020-02-20 15:17:25', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230391130385186817', 1, '用户名: jeecg,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 15:18:00', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230391194293796866', 1, '用户名: iov,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 15:18:15', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230391303135985665', 2, '职务表-分页列表查询', 1, 'iov', 'zhen', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 17, 'iov', '2020-02-20 15:18:41', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230391437991247874', 2, '职务表-分页列表查询', 1, 'iov', 'zhen', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 12, 'iov', '2020-02-20 15:19:13', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230391481289048066', 2, '职务表-分页列表查询', 1, 'iov', 'zhen', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 11, 'iov', '2020-02-20 15:19:23', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230391534049198081', 1, '用户名: zhen,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 15:19:36', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230391564759891969', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 15:19:43', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230395710841991170', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 15:36:11', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230396044331102209', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 362, 'admin', '2020-02-20 15:37:31', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230396187361062914', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 28, 'admin', '2020-02-20 15:38:05', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230397020161093634', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 20, 'admin', '2020-02-20 15:41:24', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230397045922508801', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 24, 'admin', '2020-02-20 15:41:30', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230397307810656257', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 15:42:33', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230397908351102977', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 15:44:56', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230403192645660673', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 16:05:56', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230403387190063106', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 14, 'admin', '2020-02-20 16:06:42', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230403445306339330', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 16:06:56', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230403518324977665', 1, '用户名: iov,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 16:07:13', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230403577296891906', 2, '职务表-分页列表查询', 1, 'iov', 'zhen', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 19, 'iov', '2020-02-20 16:07:27', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230404613814267906', 2, '职务表-分页列表查询', 1, 'iov', 'zhen', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 26, 'iov', '2020-02-20 16:11:34', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230406740737437697', 1, '用户名: zhen,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-20 16:20:02', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230736663301750785', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 14:11:01', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230743546964107265', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 14:38:22', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230749012947558401', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 15:00:05', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230749091506872322', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 15:00:24', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230749143012925441', 2, '填值规则-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysFillRuleController.queryPageList()', NULL, NULL, NULL, 154, 'admin', '2020-02-21 15:00:37', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230749673974063105', 2, '填值规则-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysFillRuleController.queryPageList()', NULL, NULL, NULL, 15, 'admin', '2020-02-21 15:02:43', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230753894224027649', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 15:19:29', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230754362941693954', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 15:21:21', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230759099036524545', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 15:40:10', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230759179990786049', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 15:40:30', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230759746012110850', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 15:42:45', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230759804031918081', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 15:42:58', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230778901104836610', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 16:58:51', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230779089219371009', 1, '用户登录失败，用户不存在！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 16:59:36', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230779117971324929', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 16:59:43', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230786267548368898', 2, '填值规则-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysFillRuleController.queryPageList()', NULL, NULL, NULL, 35, 'admin', '2020-02-21 17:28:08', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230821273356398594', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-21 19:47:13', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1230829484008517634', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '192.168.1.6', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 90, 'admin', '2020-02-21 20:19:51', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1231115136373526529', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-22 15:14:55', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1231115225401823234', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-22 15:15:17', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1231140234132353025', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-22 16:54:39', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1231140538693349377', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-22 16:55:53', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232221107506282498', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-25 16:29:39', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232221167518384130', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-25 16:29:55', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232284105860104194', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-25 20:39:59', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232284190140448770', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-25 20:40:20', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232558573081767937', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-26 14:50:38', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232558757018775553', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-26 14:51:22', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232615638097616897', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-26 18:37:23', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232615742904885250', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-26 18:37:49', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232646946802794497', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-26 20:41:48', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232647044131618817', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-26 20:42:11', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232662721789853698', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-26 21:44:29', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232931851717746689', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-27 15:33:54', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232937922066825217', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-27 15:58:02', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232937965259767810', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-27 15:58:12', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232999023345311746', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-27 20:00:49', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1232999164248760321', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-27 20:01:23', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1233022982010863618', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-27 21:36:02', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1233023031541399553', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-27 21:36:14', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1233277463499796482', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-28 14:27:14', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1233277538598809602', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-28 14:27:33', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1233379978832752642', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-28 21:14:36', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1233385351572598786', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-28 21:35:58', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1233413790681772034', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-28 23:28:58', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1233413881626865666', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '192.168.1.6', NULL, NULL, NULL, NULL, NULL, NULL, '2020-02-28 23:29:20', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242326861563215873', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-24 13:46:19', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242354938477473793', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 66, 'admin', '2020-03-24 15:37:53', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242357321446125569', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-24 15:47:22', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242358364762468353', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 19, 'admin', '2020-03-24 15:51:31', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242359437942255618', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 13, 'admin', '2020-03-24 15:55:47', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242360010427002882', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 31, 'admin', '2020-03-24 15:58:03', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242360128282750978', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 11, 'admin', '2020-03-24 15:58:31', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242360722192003074', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 20, 'admin', '2020-03-24 16:00:53', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242361824614477826', 2, '编辑用户，id： e9ca23d68d884d4ebb19d07889727dae', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2020-03-24 16:05:16', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242361923440668674', 2, '编辑用户，id： e9ca23d68d884d4ebb19d07889727dae', 2, 'admin', '管理员', '127.0.0.1', NULL, NULL, NULL, NULL, NULL, 'admin', '2020-03-24 16:05:39', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242365491971289089', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 10, 'admin', '2020-03-24 16:19:50', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242365725195563009', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 11, 'admin', '2020-03-24 16:20:46', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242365842887733249', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 9, 'admin', '2020-03-24 16:21:14', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242366751839547394', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 12, 'admin', '2020-03-24 16:24:50', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242394736923639810', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 71, 'admin', '2020-03-24 18:16:02', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242737356254351361', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-25 16:57:29', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242737479868878849', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-25 16:57:59', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242737801890762754', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-25 16:59:16', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242738033181462530', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-25 17:00:11', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242738358483292162', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 87, 'admin', '2020-03-25 17:01:28', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242739990256291841', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 14, 'admin', '2020-03-25 17:07:57', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242749728121647106', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 35, 'admin', '2020-03-25 17:46:38', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242755905245114369', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 17, 'admin', '2020-03-25 18:11:12', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242789123407122433', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-25 20:23:11', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242789256760823809', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-25 20:23:43', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242789417352335362', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-25 20:24:22', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1242789470120873985', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-25 20:24:34', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243098964205953026', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-26 16:54:23', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243099026017411073', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-26 16:54:38', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243099337914245121', 2, '职务表-分页列表查询', 1, 'admin', '管理员', '127.0.0.1', 'org.jeecg.modules.system.controller.SysPositionController.queryPageList()', NULL, NULL, NULL, 479, 'admin', '2020-03-26 16:55:52', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243127556327530498', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-26 18:48:00', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243128025095507969', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-26 18:49:52', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243456122097418241', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-27 16:33:36', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243456190913363969', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-27 16:33:53', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243492670205501442', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-27 18:58:50', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243493900315172865', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-27 19:03:43', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243838598410043394', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-28 17:53:25', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243838667540561922', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-28 17:53:42', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243840926060019714', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-28 18:02:41', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1243895908864000001', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-28 21:41:10', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1244532076483874818', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-30 15:49:03', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1244532947682758657', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-30 15:52:32', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1244539411772116993', 1, '用户名: 管理员,退出成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-30 16:18:13', NULL, NULL);
INSERT INTO `sys_log` VALUES ('1244539634577739778', 1, '用户名: admin,登录成功！', NULL, NULL, NULL, '127.0.0.1', NULL, NULL, NULL, NULL, NULL, NULL, '2020-03-30 16:19:06', NULL, NULL);
...
INSERT INTO `sys_permission` VALUES ('1230779806139170818', '', '车联网', '/iov', 'layouts/RouteView', NULL, NULL, 0, NULL, '1', 1.00, 0, NULL, 1, 0, 0, 0, NULL, 'admin', '2020-02-21 17:02:27', 'admin', '2020-02-21 17:18:43', 0, 0, '1', 0);
INSERT INTO `sys_permission` VALUES ('1230780580126670849', '1230779806139170818', '车辆管理', '/iov/car', 'modules/iov/CarList', NULL, NULL, 1, NULL, '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2020-02-21 17:05:32', 'admin', '2020-02-21 20:28:08', 0, 1, '1', 0);
INSERT INTO `sys_permission` VALUES ('1230782815665537025', '1230779806139170818', '故障码', '/iov/breakdown', 'modules/iov/BreakdownList', NULL, NULL, 1, NULL, '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2020-02-21 17:14:25', NULL, NULL, 0, 0, '1', 0);
INSERT INTO `sys_permission` VALUES ('1230785668077469698', '1230779806139170818', '车况', '/iov/carStatus', 'modules/iov/CarStatusList', NULL, NULL, 1, NULL, '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2020-02-21 17:25:45', 'admin', '2020-03-24 17:10:39', 0, 1, '1', 0);
INSERT INTO `sys_permission` VALUES ('1233005779920248834', '1230779806139170818', '行车记录', '/iov/log', 'modules/iov/CarLogList', NULL, NULL, 1, NULL, '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2020-02-27 20:27:40', NULL, NULL, 0, 0, '1', 0);
INSERT INTO `sys_permission` VALUES ('1243466964129988610', '1230779806139170818', '车队管理', '/iov/motorcade', 'modules/iov/MotorcadeList', NULL, NULL, 1, NULL, '1', 1.00, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2020-03-27 17:16:41', NULL, NULL, 0, 0, '1', 0);
...
-- ----------------------------
INSERT INTO `sys_permission_data_rule` VALUES ('1230831568070094849', '1230780580126670849', '车主', 'createBy', '=', '#{sys_user_code}', '1', '2020-02-21 20:28:08', 'admin', NULL, NULL);
INSERT INTO `sys_permission_data_rule` VALUES ('1242378278957150210', '1230785668077469698', '车主', 'createBy', '=', '#{sys_user_code}', '1', '2020-03-24 17:10:39', 'admin', '2020-03-24 17:23:38', 'admin');
...
INSERT INTO `sys_position` VALUES ('1230390723017605122', 'useradmin', '总理', '5', NULL, 'admin', '2020-02-20 15:16:23', NULL, NULL, 'A01');
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES ('1230389491897106433', '公司管理', 'useradmin', NULL, 'admin', '2020-02-20 15:11:29', NULL, NULL);
...
INSERT INTO `sys_role_permission` VALUES ('1230390098930335746', '1230389491897106433', '45c966826eeff4c99b8f8ebfe74511fc', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230390098955501570', '1230389491897106433', '5c2f42277948043026b7a14692456828', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230390098955501571', '1230389491897106433', '3f915b2769fc80648e92d04e84ca059d', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230390098968084482', '1230389491897106433', 'd7d6e2e4e2934f2c9385a623fd98c6f3', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106246967298', '1230389491897106433', '1a0811914300741f4e11838ff37a1d3a', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106263744514', '1230389491897106433', '7593c9e3523a17bca83b8d7fe8a34e58', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106263744515', '1230389491897106433', '190c2b43bec6a5f7a4194a85db67d96a', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106272133121', '1230389491897106433', '54dd5457a3190740005c1bfec55b1c34', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106272133122', '1230389491897106433', '1174506953255182338', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106284716033', '1230389491897106433', 'e8af452d8948ea49d37c934f5100ae6a', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106284716034', '1230389491897106433', 'f1cb187abf927c88b89470d08615f5ac', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106293104641', '1230389491897106433', '1174590283938041857', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106301493250', '1230389491897106433', 'ebb9d82ea16ad864071158e0c449d186', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106301493251', '1230389491897106433', 'e08cb190ef230d5d4f03824198773950', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230391106309881857', '1230389491897106433', '1170592628746878978', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230779986599100417', 'f6817f48af4fb3af11b9e8bf182f618b', '1230779806139170818', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230780744467890177', 'f6817f48af4fb3af11b9e8bf182f618b', '1230780580126670849', '1230822545253920769,1230831568070094849');
INSERT INTO `sys_role_permission` VALUES ('1230782889330098178', 'f6817f48af4fb3af11b9e8bf182f618b', '1230782815665537025', NULL);
INSERT INTO `sys_role_permission` VALUES ('1230785727493980161', 'f6817f48af4fb3af11b9e8bf182f618b', '1230785668077469698', '1232284678692978689,1242378278957150210');
INSERT INTO `sys_role_permission` VALUES ('1230825389822566402', 'f6817f48af4fb3af11b9e8bf182f618b', '1230824658059124738', '1230825201900969985');
INSERT INTO `sys_role_permission` VALUES ('1233005866075447297', 'f6817f48af4fb3af11b9e8bf182f618b', '1233005779920248834', NULL);
INSERT INTO `sys_role_permission` VALUES ('1233015676418306049', 'f6817f48af4fb3af11b9e8bf182f618b', '1233015636933128194', NULL);
INSERT INTO `sys_role_permission` VALUES ('1242358842850209794', 'f6817f48af4fb3af11b9e8bf182f618b', 'e8af452d8948ea49d37c934f5100ae6a', NULL);
INSERT INTO `sys_role_permission` VALUES ('1242358842850209795', 'f6817f48af4fb3af11b9e8bf182f618b', '1170592628746878978', NULL);
INSERT INTO `sys_role_permission` VALUES ('1243467094602203137', 'f6817f48af4fb3af11b9e8bf182f618b', '1243466964129988610', NULL);
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1230389812211908609', 'iov', 'zhen', '0cd4c368ae170416', 'B2TQrMae', NULL, NULL, NULL, NULL, NULL, 'A03', 1, 0, 1, '202', NULL, NULL, 'admin', '2020-02-20 15:12:45', NULL, NULL);
INSERT INTO `sys_user` VALUES ('42d153bffeea74f72a9c1697874fa4a7', 'test22', '23232', '2e80339747e5f91d', 'rKDLHsjo', 'user/20190314/ly-plate-e_1552531617500.png', '2019-02-09 00:00:00', 1, 'zhangdaiscott@163.com', '18611782222', 'A02', 1, 0, 1, NULL, NULL, NULL, 'admin', '2019-01-26 18:01:10', 'admin', '2020-02-20 14:51:35');
...
INSERT INTO `sys_user` VALUES ('e9ca23d68d884d4ebb19d07889727dae', 'admin', '管理员', 'cb362cfeefbf3d8d', 'RCGTeGiH', 'user/20190119/logo-2_1547868176839.png', '2018-12-05 00:00:00', 1, '11@qq.com', '18566666661', 'A01', 1, 0, 1, '111', '', NULL, NULL, '2038-06-21 17:54:10', 'admin', '2020-03-24 16:05:39');
...
-- ----------------------------
INSERT INTO `sys_user_depart` VALUES ('1230390384554049538', '1230389812211908609', '2dc24b0ade8840499bee21225bf61222');
...
INSERT INTO `sys_user_depart` VALUES ('1242361923914625025', 'e9ca23d68d884d4ebb19d07889727dae', 'c6d7cb4deeac411cb3384b1b31278596');
...
INSERT INTO `sys_user_role` VALUES ('1230389812262240257', '1230389812211908609', '1230389491897106433');
...
INSERT INTO `sys_user_role` VALUES ('1242361923470028801', 'e9ca23d68d884d4ebb19d07889727dae', 'f6817f48af4fb3af11b9e8bf182f618b');
